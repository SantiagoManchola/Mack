...
<head>
    ...
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1478182898948673&ev=PageView&noscript=1" /></noscript>
...
<body>
    ...
    <main id="wrapper">
        ...
        <div class="homepage-content">
            <img src="./assets/images/mack-pracodidacol.jpg" alt="">
        </div>
        <!--Form-->
        ...
        <div class="form-content">
            <div class="container container-form">
                <section class="container_form_mack">
                    ...
                    <div class="bg_form">
                        <h5 class="d-flex mb-2"><img src="assets/images/icon-contact.svg" /> TU INFORMACIÓN</h5>
                        <form id="FormCotizar" action="enviarcorreo.php" method="post" novalidate="novalidate">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <button type="submit" id="btnSubmit" class="btn btn-primary block w-full">ENVIAR</button>
                                </div>
