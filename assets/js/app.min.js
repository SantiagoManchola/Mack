...
jQuery(window).load(function(){"use strict";jQuery("#loader").delay(100).fadeOut(),jQuery("#loader-wrapper").delay(100).fadeOut("fast"),jQuery(window).ready(function(){jQuery('.checkAutorizo input[type="radio"]').click(function(){jQuery(this).is(":checked")&&(Swal.fire({title:!1,html:'<img src="./assets/images/logo.svg" class="image-modal-tratamiento-datos" /><div class="modal-tratamiento-datos"><h4>Te informamos tus derechos como Titular de Datos Personales y los deberes del Responsable del Tratamiento de tus Datos</h4><p><b>a)</b> Tienes derecho a conocer, actualizar y rectificar tus datos personales, así como a solicitar prueba de la autorización otorgada al responsable del Tratamiento.</p><p><b>b)</b> El Responsable del Tratamiento deberá informarte previa recolección de tus Datos el Tratamiento que se le dará y la finalidad del mismo. Recuerda que las finalidades te las informamos en el escrito de autorización que encuentras <a href="../wp-content/themes/pracodidacol/assets/pdf/FINALIDADES DE LA AUTORIZACIÓN PARA EL USO Y TRATAMIENTO DE DATOS PERSONALES.pdf" target="_blank">Aquí.</a></p><p><b>c)</b> Tienes derecho a revocar la autorización y a solicitar la supresión de tus Datos. </p><p><b>d)</b> Ante la Superintendencia de Industria y Comercio podrás presentar quejas por infracciones a la Ley 1581 de 2012 en las que incurra el Responsable.</p><p>En caso de que desees revocar tu autorización o tengas alguna consulta o reclamo en materia de datos personales contáctanos al correo electrónico: <a href="mailto:didacol@didacol.com" target="_blank">didacol@didacol.com</a></p><p>Puedes consultar nuestra política de tratamiento aquí: <a href="https://www.pracodidacol.com/" target="_blank">www.pracodidacol.com</a></p></div>',confirmButtonText:"Entendido"}),jQuery(".checkAutorizoInfo").slideDown(300),jQuery("body, html").animate({scrollTop:jQuery(jQuery(".checkAutorizoInfo")).offset().top-350},300))}),jQuery('.checkNoAutorizo input[type="radio"]').click(function(){jQuery(this).is(":checked")&&jQuery(".checkAutorizoInfo").slideUp(300)})}),jQuery(window).on("scroll",function(){var e=jQuery(window).scrollTop();72<e?jQuery(".navbar").addClass("scroll"):jQuery(".navbar").removeClass("scroll");var o=jQuery(window).height();o<e?jQuery(".bgForm").addClass("close"):jQuery(".bgForm").removeClass("close").removeClass("open"),o<e?jQuery(".openForm").addClass("open"):jQuery(".openForm").removeClass("open")})}),jQuery(document).ready(function(t){"use strict";t(".navbar-nav li.nav-item").on("click",function(){t("#navbarSupportedContent").css("height","1px").removeClass("in").addClass("collapse"),t("#navbarSupportedContent").removeClass("show")}),t(".openForm").on("click",function(){t(".bgForm").toggleClass("open")}),t(".slim-wrap ul.menu-items.collapsed li a").on("click",function(){t(".collapse-button").click()}),t('.header a[href^="#"], .page a.btn[href^="#"], .page a.internal-link[href^="#"]').on("click",function(e){e.preventDefault();var o=this.hash,e=jQuery(o);t("html, body").stop().animate({scrollTop:e.offset().top-60},"slow","easeInSine",function(){window.location.hash="1"+o})}),t.scrollUp=function(e){var o=t.extend({},{scrollName:"scrollUp",topDistance:600,topSpeed:800,animation:"fade",animationInSpeed:200,animationOutSpeed:200,scrollText:"",scrollImg:!1,activeOverlay:!1},e),a="#"+o.scrollName;t("<a/>",{id:o.scrollName,href:"#top",title:o.scrollText}).appendTo("body"),o.scrollImg||t(a).text(o.scrollText),t(a).css({display:"none",position:"fixed","z-index":"2147483647"}),o.activeOverlay&&(t("body").append("<div id='"+o.scrollName+"-active'></div>"),t(a+"-active").css({position:"absolute",top:o.topDistance+"px",width:"100%","border-top":"1px dotted "+o.activeOverlay,"z-index":"2147483647"})),t(window).on("scroll",function(){switch(o.animation){case"fade":t(t(window).scrollTop()>o.topDistance?t(a).fadeIn(o.animationInSpeed):t(a).fadeOut(o.animationOutSpeed));break;case"slide":t(t(window).scrollTop()>o.topDistance?t(a).slideDown(o.animationInSpeed):t(a).slideUp(o.animationOutSpeed));break;default:t(t(window).scrollTop()>o.topDistance?t(a).show(0):t(a).hide(0))}}),t(a).on("click",function(e){t("html, body").animate({scrollTop:0},o.topSpeed),e.preventDefault()})},t.scrollUp()});